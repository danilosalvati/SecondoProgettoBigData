...
public class Keywords250TopMovies {
	...
	public static void main(String[] args) throws ClassNotFoundException,
		...
		if (args.length != 2) {
			System.err
					.println("USAGE: <hdfs keywords path> <hdfs output path>");
			System.exit(1);
		}
		...
		job.setMapperClass(Keywords250TopMoviesMapper.class);

		job.setNumReduceTasks(1);

		job.setReducerClass(Keywords250TopMoviesReducer.class);
		job.setReducerClass(Keywords250TopMoviesReducer.class);
