...
public class ActorsAndActresses250TopMoviesMapper extends
	...
	private static List<String> top250movies = null;
	...
	protected void setup(Context context) throws IOException,
		...
		if (top250movies == null) {
			...
			Path path = new Path("hdfs://input/top250movies.list");
		...
		// top250movies.add("boh"); //se decommenti questa riga va ma tira fuori
		// dati sbagliati
