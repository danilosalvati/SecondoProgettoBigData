...
/**
 * Il mapper costruisce le coppie (film, 1) se il film è nei top 250 e le invia
 * al reducer
 *
 */
public class QuotesNumberFor250TopMoviesMapper extends
	...
	public void map(Object key, Text value, Context context)
		...
		if (values[1].contains("<ENDVALUE>")) {
			String[] quotes = values[1].split("<ENDVALUE>");

			for (String quote : quotes) {
				/*
				 * Scrivo la coppia (film, 1) se il film è nei top 250
				 */
