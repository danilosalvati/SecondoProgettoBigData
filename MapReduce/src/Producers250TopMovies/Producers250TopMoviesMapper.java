...
/**
 * Il mapper costruisce le coppie (produttore, 1) se il film è nei top 250 e le
 * invia al reducer
 *
 */
public class Producers250TopMoviesMapper extends
	...
	public void map(Object key, Text value, Context context)
		...
		if (values[1].contains("<ENDVALUE>")) {
			...
			for (String movie : movies) {
				/*
				 * Scrivo la coppia (produttore, 1) per tutti i film del produttore
				 * nei top 250
				 */
