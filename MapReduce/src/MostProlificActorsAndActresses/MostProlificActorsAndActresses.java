...
public class MostProlificActorsAndActresses {
	...
	public static void main(String[] args) throws ClassNotFoundException,
		...
		Job job = Job.getInstance(conf, "MostProlificActorsAndActresses");

		job.setJarByClass(MostProlificActorsAndActresses.class);
