package com.facebook.presto.sql.gen.generated;
...
public final class BenchmarkPageProcessor_handCoded {
    ...
    public Collection<? extends Result> handCoded_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BenchmarkPageProcessor_1_jmh l_benchmarkpageprocessor0_0 = _jmh_tryInit_f_benchmarkpageprocessor0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_benchmarkpageprocessor0_0.handCoded());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            handCoded_thrpt_jmhLoop(control, res, l_benchmarkpageprocessor0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                if (l_benchmarkpageprocessor0_0.readyTrial) {
                    l_benchmarkpageprocessor0_0.readyTrial = false;
                }
                f_benchmarkpageprocessor0_0 = null;
                f_blackhole1_1 = null;
            }
            Collection<Result> results = new ArrayList<Result>();
            results.add(new ThroughputResult(ResultRole.PRIMARY, "handCoded", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void handCoded_thrpt_jmhLoop(InfraControl control, RawResults result, BenchmarkPageProcessor_1_jmh l_benchmarkpageprocessor0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> handCoded_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BenchmarkPageProcessor_1_jmh l_benchmarkpageprocessor0_0 = _jmh_tryInit_f_benchmarkpageprocessor0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            handCoded_avgt_jmhLoop(control, res, l_benchmarkpageprocessor0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "handCoded", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void handCoded_avgt_jmhLoop(InfraControl control, RawResults result, BenchmarkPageProcessor_1_jmh l_benchmarkpageprocessor0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> handCoded_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BenchmarkPageProcessor_1_jmh l_benchmarkpageprocessor0_0 = _jmh_tryInit_f_benchmarkpageprocessor0_0(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            handCoded_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_benchmarkpageprocessor0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_benchmarkpageprocessor0_0.handCoded());
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "handCoded", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void handCoded_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, BenchmarkPageProcessor_1_jmh l_benchmarkpageprocessor0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> handCoded_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BenchmarkPageProcessor_1_jmh l_benchmarkpageprocessor0_0 = _jmh_tryInit_f_benchmarkpageprocessor0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            handCoded_ss_jmhStub(control, batchSize, res, l_benchmarkpageprocessor0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_blackhole1_1.readyIteration) {
                l_blackhole1_1.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "handCoded", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void handCoded_ss_jmhStub(InfraControl control, int batchSize, RawResults result, BenchmarkPageProcessor_1_jmh l_benchmarkpageprocessor0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    BenchmarkPageProcessor_1_jmh f_benchmarkpageprocessor0_0;
    
    BenchmarkPageProcessor_1_jmh _jmh_tryInit_f_benchmarkpageprocessor0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_benchmarkpageprocessor0_0 == null) {
            BenchmarkPageProcessor_1_jmh val = new BenchmarkPageProcessor_1_jmh();
            val.setup();
            val.readyTrial = true;
            f_benchmarkpageprocessor0_0 = val;
        }
        return f_benchmarkpageprocessor0_0;
    }
    ...
    static class BenchmarkPageProcessor_1_jmh_B1 extends com.facebook.presto.sql.gen.BenchmarkPageProcessor {
    ...
    static class BenchmarkPageProcessor_1_jmh_B2 extends BenchmarkPageProcessor_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkPageProcessor_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkPageProcessor_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkPageProcessor_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkPageProcessor_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkPageProcessor_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkPageProcessor_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class BenchmarkPageProcessor_1_jmh_B3 extends BenchmarkPageProcessor_1_jmh_B2 {
    ...
    static final class BenchmarkPageProcessor_1_jmh extends BenchmarkPageProcessor_1_jmh_B3 {
    }
