...
def parseOptions
  configurable_options = {
      :s3_path_to_presto_server_bin => "s3://bigmetabucket/Scripts/presto-server-0.85.tar.gz",
      :s3_path_to_presto_cli => "s3://bigmetabucket/Scripts/presto-cli-0.85-executable.jar",
