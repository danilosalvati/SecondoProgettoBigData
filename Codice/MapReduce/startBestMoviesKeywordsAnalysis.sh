...
{ time hadoop jar MapReduce-1.0.jar Keywords250TopMovies/Keywords250TopMovies /input/keywordsENDVALUE.list /outputBestMoviesKeywords ; } 2> Result/Times/BestMoviesKeywords/tmp.txt 
